...
namespace Rivet {
  ...
  class TZQ_DILEPTON_2016 : public Analysis {
  public:

    /// Constructor
    TZQ_DILEPTON_2016() : Analysis("TZQ_DILEPTON_2016")
    {
    }
    ...
    void analyze(const Event& event) {
      ...
      double z_mass_reco;
       ...
       if((lepton.abspid() == 11 && lepton.pT() > 35*GeV) || (lepton.abspid() == 13 && lepton.pT() > 26*GeV)){
...
//	}
  ...
  DECLARE_RIVET_PLUGIN(TZQ_DILEPTON_2016);
